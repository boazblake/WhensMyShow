...
var Details = function Details() {
  ...
  return {
    ...
    view: function view() {
      return (0, _mithril2.default)(".contains", [(0, _mithril2.default)("h1", "DETAILS PAGE"), (0, _mithril2.default)("code", (0, _mithril2.default)("pre", JSON.stringify(data, null, 4)))]);
    }
  };
};
  ...
  return {
    view: function view(_ref) {
      ...
      return filterShowsByList(mdl).map(function (show, idx) {
        ...
        }), isHovered == idx && (0, _mithril2.default)("b.btn btn-action btn-error btn-s s-circle deleteIcon", {
          onclick: function onclick() {
            alert("deleting");
            deleteShow(show, mdl);
          }
