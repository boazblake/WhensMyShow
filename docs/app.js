...
var Model = {
  ...
  state: state,
  user: user,
  data: (0, _mithrilStream2.default)([]),
...
var SearchInput = function SearchInput() {
  var searchShows = function searchShows(mdl) {
    return _http2.default.getTask(_http2.default.searchUrl(mdl.state.page())(mdl.state.query())).map(_fns.formatSearchData).map((0, _fns.mergeWithCurrentList)(mdl.user.shows())).fork(function (err) {
...
var updateUserShows = function updateUserShows(mdl) {
  return function (result, list) {
    return _http2.default.postTask(_http2.default.backendlessUrl, saveDto(result, list)).chain(function (_) {
      ...
      mdl.user.shows(d);
      mdl.data((0, _fns.mergeWithCurrentList)(mdl.user.shows())({ results: mdl.data() }));
    });
  };
};
  ...
  return {
    view: function view(_ref) {
      ...
      return (0, _mithril2.default)("ul.menu", mdl.user.lists().map(function (list, idx) {
        console.log("result in show list sel", result, list, list == result.status, active);
        return (0, _mithril2.default)(_Elements.ListSelector, {
          list: list,
...
var Result = function Result(_ref2) {
  ...
  var selected = userHasAlready(mdl)(result);
...
var SearchResults = function SearchResults() {
  return {
    view: function view(_ref4) {
      ...
      return (0, _mithril2.default)("section.tiles", mdl.data() ? mdl.data().map(function (result, idx) {
...
exports.mergeWithCurrentList = exports.formatSearchData = exports.toSearchVm = undefined;
