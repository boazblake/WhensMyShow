  ...
  return {
    view: function view(_ref) {
      ...
      return filterShowsByList(mdl).map(function (show, idx) {
        ...
        }, [isHovered == idx && (0, _mithril2.default)("b.btn btn-action btn-error btn-s s-circle deleteIcon", { onclick: function onclick() {
            return deleteShow(show, mdl);
          } }, (0, _mithril2.default)("i.icon icon-cross")), (0, _mithril2.default)("img.img-responsive.img-fit-cover", {
