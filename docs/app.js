...
var Header = function Header() {
  return {
    view: function view(_ref3) {
      ...
      return (0, _mithril2.default)("section.header", [mdl.state.isLoading() && (0, _mithril2.default)(_Elements.ProgressBar, { mdl: mdl }),
  ...
  return {
    view: function view(_ref5) {
      ...
      return m(".menu.columns", [m("div.form-group.col-6", [m(TextBlock, {
        ...
        src: show.image
      }), (show.network || show.webChannel) && m(TextBlock, {
        label: "Channel: ",
        ...
        } }, m("a.h2", "Episodes", m("i.icon " + (showLinks ? "icon-arrow-down" : "icon-arrow-right"))), m(".accordion-body", showLinks && show.links.map(function (eps, idx) {
  ...
  return {
    view: function view(_ref) {
      ...
      return (0, _fns.filterShowsByListType)(mdl).map(function (show, idx) {
        return m("li.menu", {
          key: idx
        }, [m("b.btn btn-action btn-error btn-s deleteIcon ", {
          onclick: function onclick() {
            return deleteShow(mdl)(show);
          }
        }, m("i.icon icon-cross")), m("img.img-responsive.img-fit-cover", {
          onclick: function onclick() {
...
var Home = function Home() {
  return {
    ...
    view: function view(_ref3) {
      var mdl = _ref3.attrs.mdl;
      return m("ul.tiles", (0, _ramda.isEmpty)(mdl.user.shows()) ? NoShows : m(selectedShows, { mdl: mdl }));
    }
  };
};
...
var getEpisodeLink = exports.getEpisodeLink = function getEpisodeLink(path) {
  return function (links) {
    return (0, _ramda.view)((0, _ramda.lensPath)([path, "href"]), links);
  };
};

var formatLinks = function formatLinks(links) {
  return (0, _ramda.without)([undefined], [getEpisodeLink("previousepisode")(links), getEpisodeLink("nextepisode")(links)]).map(makeHttps);
};
