...
var Details = function Details() {
  ...
  return {
    ...
    view: function view() {
      return (0, _mithril2.default)(".container", [(0, _ramda.isEmpty)(data) ? (0, _mithril2.default)(_Elements.Loader) : (0, _mithril2.default)(DetailCard, { show: data })]);
    }
  };
};
...
var searchShows = exports.searchShows = function searchShows(mdl, http) {
  return http.getTask(http.searchUrl(mdl.state.paginate.page())(mdl.state.query())).map(formatSearchData).map(updateShowStatus(mdl.user.shows())).fork(function (err) {
