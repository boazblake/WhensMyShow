...
var Details = function Details() {
  return {
    ...
    view: function view(_ref4) {
      ...
      return (0, _mithril2.default)(".container", [(0, _ramda.isNil)(mdl.data.details()) ? (0, _mithril2.default)(_Elements.Loader) : (0, _mithril2.default)(DetailCard, { show: mdl.data.details() }), mdl.errors.details() !== null && (0, _mithril2.default)(".toast.toast-error", (0, _mithril2.default)("p", mdl.errors.details().response.status_message), (0, _mithril2.default)("p", "Choose a different show"))]);
    },
...
exports.getShowDetailsTask = exports.deleteShowTask = exports.updateUserShowsTask = exports.addUserShowsTask = exports.saveDto = exports.showListSelection = exports.propIsDefined = exports.searchShows = exports.getShows = exports.updateShowStatus = exports.formatSearchData = exports.filterIncorrectAttrTypes = exports.toSearchVm = exports.log = undefined;
...
exports.jsonCopy = exports.scrollToAnchor = exports.debounce = exports.filterTask = exports._paginate = exports._direction = exports._sort = exports._search = exports.addTerms = exports.infiniteScroll = exports.isEmpty = exports.log = undefined;
